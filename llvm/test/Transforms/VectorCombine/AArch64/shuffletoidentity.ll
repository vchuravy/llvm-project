...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[SHUFFLE:%.*]] = shufflevector <2 x i64> [[TMP0:%.*]], <2 x i64> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
; CHECK-NEXT:    [[CONV:%.*]] = trunc <4 x i64> [[SHUFFLE]] to <4 x i16>
; CHECK-NEXT:    [[VECINIT4_I:%.*]] = shufflevector <4 x i16> [[CONV]], <4 x i16> poison, <4 x i32> <i32 2, i32 poison, i32 2, i32 poison>
; CHECK-NEXT:    [[SUB_I:%.*]] = sub <4 x i16> [[CONV]], [[VECINIT4_I]]
; CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <4 x i16> [[SUB_I]], <4 x i16> poison, <2 x i32> <i32 0, i32 2>
